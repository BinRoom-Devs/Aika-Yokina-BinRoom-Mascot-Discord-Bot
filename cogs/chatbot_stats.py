...
class AIChatbotStats(commands.Cog):
    ...
    async def ai_chatbot_stats(self, ctx:commands.Context):
        ...
        embed.set_author(name="Ditenagai oleh Groq Qwen 3.8 27B", icon_url="https://cdn.discordapp.com/attachments/863959650448703538/1541386627434414160/Groq_Icon_-_Colored_-_338x512_-_zonalogo.com.png?ex=6a8d67a9&is=6a8c1629&hm=c61d6312865796f54c472103ae51b2151c003287f865e61473b29ec7d18d677a&")
