...
class CekKuotaAI(commands.Cog):
    ...
    async def cek_kuota_ai(self, ctx:commands.Context):
        ...
        embed.set_author(name="Ditenagai oleh Groq Qwen 3.8 27B", icon_url="https://cdn.discordapp.com/attachments/863959650448703538/1541385549254885506/groq-icon-logo-png_seeklogo-605779.png?ex=6a8eb828&is=6a8d66a8&hm=210df3a52c0d20e870523919d668d7be881ca5c3862e4735e12c65f4955f762a&")
